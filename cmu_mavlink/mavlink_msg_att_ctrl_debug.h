...
#define MAVLINK_MSG_ID_ATT_CTRL_DEBUG_LEN 140
#define MAVLINK_MSG_ID_ATT_CTRL_DEBUG_MIN_LEN 140
#define MAVLINK_MSG_ID_223_LEN 140
#define MAVLINK_MSG_ID_223_MIN_LEN 140

#define MAVLINK_MSG_ID_ATT_CTRL_DEBUG_CRC 161
#define MAVLINK_MSG_ID_223_CRC 161
...
static inline uint16_t mavlink_msg_att_ctrl_debug_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, const float *rpm, const float *eOm, const float *Omd, const float *eR, const float *Rd, const float *R)
{
...
{
    return mavlink_msg_att_ctrl_debug_pack(system_id, component_id, msg, att_ctrl_debug->time_usec, att_ctrl_debug->rpm, att_ctrl_debug->eOm, att_ctrl_debug->Omd, att_ctrl_debug->eR, att_ctrl_debug->Rd, att_ctrl_debug->R);
}
...
{
    return mavlink_msg_att_ctrl_debug_pack_chan(system_id, component_id, chan, msg, att_ctrl_debug->time_usec, att_ctrl_debug->rpm, att_ctrl_debug->eOm, att_ctrl_debug->Omd, att_ctrl_debug->eR, att_ctrl_debug->Rd, att_ctrl_debug->R);
}
...
static inline void mavlink_msg_att_ctrl_debug_send(mavlink_channel_t chan, uint64_t time_usec, const float *rpm, const float *eOm, const float *Omd, const float *eR, const float *Rd, const float *R)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATT_CTRL_DEBUG_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_att_ctrl_debug_send(chan, att_ctrl_debug->time_usec, att_ctrl_debug->rpm, att_ctrl_debug->eOm, att_ctrl_debug->Omd, att_ctrl_debug->eR, att_ctrl_debug->Rd, att_ctrl_debug->R);
#else
 ...
 */
static inline void mavlink_msg_att_ctrl_debug_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, const float *rpm, const float *eOm, const float *Omd, const float *eR, const float *Rd, const float *R)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
