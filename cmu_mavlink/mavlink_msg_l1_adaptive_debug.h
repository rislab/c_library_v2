...
#define MAVLINK_MSG_L1_ADAPTIVE_DEBUG_FIELD_RPM_LEN 4
...
#define MAVLINK_MESSAGE_INFO_L1_ADAPTIVE_DEBUG { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_l1_adaptive_debug_t, timestamp) }, \
         { "seq_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 84, offsetof(mavlink_l1_adaptive_debug_t, seq_id) }, \
         ...
         { "rpm", NULL, MAVLINK_TYPE_FLOAT, 4, 56, offsetof(mavlink_l1_adaptive_debug_t, rpm) }, \
         { "rates", NULL, MAVLINK_TYPE_FLOAT, 3, 72, offsetof(mavlink_l1_adaptive_debug_t, rates) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_L1_ADAPTIVE_DEBUG { \
 ...
 * @param rpm  RPM Hat Motor Values
...
static inline uint16_t mavlink_msg_l1_adaptive_debug_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint16_t seq_id, const float *avl_hat, const float *dst_hat, const float *ang_vel, const float *lpd, const float *rpm, const float *rates)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_L1_ADAPTIVE_DEBUG_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
    _mav_put_uint16_t(buf, 84, seq_id);
    ...
    _mav_put_float_array(buf, 56, rpm, 4);
    _mav_put_float_array(buf, 72, rates, 3);
...
{
    return mavlink_msg_l1_adaptive_debug_pack(system_id, component_id, msg, l1_adaptive_debug->timestamp, l1_adaptive_debug->seq_id, l1_adaptive_debug->avl_hat, l1_adaptive_debug->dst_hat, l1_adaptive_debug->ang_vel, l1_adaptive_debug->lpd, l1_adaptive_debug->rpm, l1_adaptive_debug->rates);
}
...
{
    return mavlink_msg_l1_adaptive_debug_pack_chan(system_id, component_id, chan, msg, l1_adaptive_debug->timestamp, l1_adaptive_debug->seq_id, l1_adaptive_debug->avl_hat, l1_adaptive_debug->dst_hat, l1_adaptive_debug->ang_vel, l1_adaptive_debug->lpd, l1_adaptive_debug->rpm, l1_adaptive_debug->rates);
}
...
static inline void mavlink_msg_l1_adaptive_debug_send(mavlink_channel_t chan, uint64_t timestamp, uint16_t seq_id, const float *avl_hat, const float *dst_hat, const float *ang_vel, const float *lpd, const float *rpm, const float *rates)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_L1_ADAPTIVE_DEBUG_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_l1_adaptive_debug_send(chan, l1_adaptive_debug->timestamp, l1_adaptive_debug->seq_id, l1_adaptive_debug->avl_hat, l1_adaptive_debug->dst_hat, l1_adaptive_debug->ang_vel, l1_adaptive_debug->lpd, l1_adaptive_debug->rpm, l1_adaptive_debug->rates);
#else
 ...
 */
static inline void mavlink_msg_l1_adaptive_debug_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint16_t seq_id, const float *avl_hat, const float *dst_hat, const float *ang_vel, const float *lpd, const float *rpm, const float *rates)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field rpm from l1_adaptive_debug message
 *
 * @return  RPM Hat Motor Values
 */
static inline uint16_t mavlink_msg_l1_adaptive_debug_get_rpm(const mavlink_message_t* msg, float *rpm)
{
    return _MAV_RETURN_float_array(msg, rpm, 4,  56);
}
...
{
    return _MAV_RETURN_float_array(msg, rates, 3,  72);
}
...
static inline void mavlink_msg_l1_adaptive_debug_decode(const mavlink_message_t* msg, mavlink_l1_adaptive_debug_t* l1_adaptive_debug)
{
    ...
    mavlink_msg_l1_adaptive_debug_get_rpm(msg, l1_adaptive_debug->rpm);
