...
typedef struct __mavlink_global_position_int_t {
 ...
 int32_t alt; /*< Altitude (MSL). Note that virtually all GPS modules provide both WGS84 and MSL.*/
 ...
 *
 * @return Altitude (MSL). Note that virtually all GPS modules provide both WGS84 and MSL.
 */
 ...
 *
 * @return Vehicle heading (yaw angle), 0.0..359.99 degrees. If unknown, set to: UINT16_MAX
 */
