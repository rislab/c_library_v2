 ...
 *
 * @param nav_roll Current desired roll
 * @param nav_pitch Current desired pitch
 * @param nav_bearing Current desired heading
 * @param target_bearing Bearing to current waypoint/target
 * @param wp_dist Distance to active waypoint
 * @param alt_error Current altitude error
 * @param aspd_error Current airspeed error
 * @param xtrack_error Current crosstrack error on x-y plane
 ...
 *
 * @return Current desired heading
 */
 ...
 *
 * @return Bearing to current waypoint/target
 */
 ...
 *
 * @return Distance to active waypoint
 */
 ...
 *
 * @return Current crosstrack error on x-y plane
 */
