...
typedef struct __mavlink_optical_flow_t {
 ...
 float flow_rate_x; /*< Flow rate about X axis*/
 float flow_rate_y; /*< Flow rate about Y axis*/
 ...
 * @param flow_rate_x Flow rate about X axis
 * @param flow_rate_y Flow rate about Y axis
 ...
 *
 * @return Flow in x-sensor direction, angular-speed compensated
 */
 ...
 *
 * @return Flow in y-sensor direction, angular-speed compensated
 */
 ...
 *
 * @return Ground distance. Positive value: distance known. Negative value: Unknown distance
 */
