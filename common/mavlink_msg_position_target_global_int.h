...
typedef struct __mavlink_position_target_global_int_t {
 uint32_t time_boot_ms; /*< Timestamp (time since system boot). The rationale for the timestamp in the setpoint is to allow the system to compensate for the transport delay of the setpoint. This allows the system to compensate processing latency.*/
 ...
 *
 * @param time_boot_ms Timestamp (time since system boot). The rationale for the timestamp in the setpoint is to allow the system to compensate for the transport delay of the setpoint. This allows the system to compensate processing latency.
 ...
 * @param lat_int X Position in WGS84 frame
 * @param lon_int Y Position in WGS84 frame
 ...
 * @param yaw_rate yaw rate setpoint
 ...
 *
 * @return Timestamp (time since system boot). The rationale for the timestamp in the setpoint is to allow the system to compensate for the transport delay of the setpoint. This allows the system to compensate processing latency.
 */
 ...
 *
 * @return X Position in WGS84 frame
 */
 ...
 *
 * @return Y Position in WGS84 frame
 */
 ...
 *
 * @return Altitude (MSL, AGL or relative to home altitude, depending on frame)
 */
 ...
 *
 * @return X velocity in NED frame
 */
 ...
 *
 * @return Y velocity in NED frame
 */
 ...
 *
 * @return Z velocity in NED frame
 */
