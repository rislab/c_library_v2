 ...
 * @param chan9_raw RC channel 9 value.
 * @param chan10_raw RC channel 10 value.
 * @param chan11_raw RC channel 11 value.
 * @param chan12_raw RC channel 12 value.
 * @param chan13_raw RC channel 13 value.
 * @param chan14_raw RC channel 14 value.
 * @param chan15_raw RC channel 15 value.
 * @param chan16_raw RC channel 16 value.
 * @param chan17_raw RC channel 17 value.
 * @param chan18_raw RC channel 18 value.
