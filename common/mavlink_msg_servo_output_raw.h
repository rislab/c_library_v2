...
typedef struct __mavlink_servo_output_raw_t {
 uint32_t time_usec; /*< Timestamp (UNIX Epoch time or time since system boot). The receiving end can infer timestamp format (since 1.1.1970 or since system boot) by checking for the magnitude the number.*/
 ...
 uint16_t servo9_raw; /*< Servo output 9 value*/
 uint16_t servo10_raw; /*< Servo output 10 value*/
 uint16_t servo11_raw; /*< Servo output 11 value*/
 uint16_t servo12_raw; /*< Servo output 12 value*/
 uint16_t servo13_raw; /*< Servo output 13 value*/
 uint16_t servo14_raw; /*< Servo output 14 value*/
 uint16_t servo15_raw; /*< Servo output 15 value*/
 uint16_t servo16_raw; /*< Servo output 16 value*/
