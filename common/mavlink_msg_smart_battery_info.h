...
typedef struct __mavlink_smart_battery_info_t {
 int32_t capacity_full_specification; /*< Capacity when full according to manufacturer, -1: field not provided.*/
 int32_t capacity_full; /*< Capacity when full (accounting for battery degradation), -1: field not provided.*/
 ...
 uint16_t discharge_minimum_voltage; /*< Minimum per-cell voltage when discharging. If not supplied set to UINT16_MAX value.*/
 uint16_t charging_minimum_voltage; /*< Minimum per-cell voltage when charging. If not supplied set to UINT16_MAX value.*/
 uint16_t resting_minimum_voltage; /*< Minimum per-cell voltage when resting. If not supplied set to UINT16_MAX value.*/
 ...
 *
 * @param id Battery ID
 * @param capacity_full_specification Capacity when full according to manufacturer, -1: field not provided.
 * @param capacity_full Capacity when full (accounting for battery degradation), -1: field not provided.
 ...
 * @param discharge_minimum_voltage Minimum per-cell voltage when discharging. If not supplied set to UINT16_MAX value.
 * @param charging_minimum_voltage Minimum per-cell voltage when charging. If not supplied set to UINT16_MAX value.
 * @param resting_minimum_voltage Minimum per-cell voltage when resting. If not supplied set to UINT16_MAX value.
 ...
 *
 * @return Capacity when full according to manufacturer, -1: field not provided.
 */
 ...
 *
 * @return Capacity when full (accounting for battery degradation), -1: field not provided.
 */
 ...
 *
 * @return Battery weight. 0: field not provided.
 */
 ...
 *
 * @return Minimum per-cell voltage when discharging. If not supplied set to UINT16_MAX value.
 */
 ...
 *
 * @return Minimum per-cell voltage when charging. If not supplied set to UINT16_MAX value.
 */
 ...
 *
 * @return Minimum per-cell voltage when resting. If not supplied set to UINT16_MAX value.
 */
